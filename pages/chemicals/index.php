    ...
    <div class="modal__box">
        ...
        <div id="formAddChemical" class="modal__body chem-form">
            ...
            <div class="modal__footer">
                ...
                <button type="submit" class="btn btn--primary" id="btnSubmitAdd">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal แก้ไขสารเคมี -->
<div class="modal" id="modalEditChemical" role="dialog" aria-labelledby="modalEditChemicalTitle" aria-modal="true" hidden>
    <div class="modal__backdrop" id="modalEditChemicalBackdrop"></div>
    <div class="modal__box">
        <div class="modal__header">
            <h2 class="modal__title" id="modalEditChemicalTitle">แก้ไขข้อมูลสารเคมี</h2>
            <button type="button" class="modal__close" id="modalEditChemicalClose" aria-label="ปิด">×</button>
        </div>
        <div id="formEditChemical" class="modal__body chem-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="chem-cas_no">CAS No.</label>
                    <input type="text" id="ed-chem-cas_no" name="cas_no" class="form-input" placeholder="เช่น 7732-18-5">
                </div>
                <div class="form-group">
                    <label for="chem-location">ที่จัดเก็บ <span class="required">*</span></label>
                    <input type="text" id="ed-chem-location" name="location" required class="form-input" placeholder="เช่น ตู้ A ชั้น 2">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group form-group--full">
                    <label for="chem-sds_url">URL SDS</label>
                    <input type="text" id="ed-chem-sds_url" name="sds_url" class="form-input" placeholder="เช่น https://sds.com">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group form-group--full">
                    <label>ความอันตรายของสาร (เลือกได้สูงสุด 4 ข้อ)</label>
                    <div class="hazard-grid" id="hazardGridEdit">
            ...
            <div class="modal__footer">
                ...
                <button type="submit" class="btn btn--primary" id="btnSubmitEdit">บันทึก</button>
            </div>
        </div>
    </div>
</div>
